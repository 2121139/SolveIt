...
export const mockProblemsData = [{
  ...
  {
    "_id": {
        "$oid": "6581aa6bdb0ee3b9bc352d48"
    },
    "id": "transpose-matrix",
    "title": "Transpose Matrix",
    "problemStatement": "<p class='mt-3'>You are given an <code>m x n</code> 2D matrix representing an image, transpose the matrix.<br>You have to transpose the matrix <b>in-place</b>, which means you have to modify the input 2D matrix directly. <b>DO NOT</b> allocate another 2D matrix and do the transposition.</p>",
    "inputFormat": "<li>First line will contain T, number of testcases. Then the testcases follow</li><li>The first line in each testcase contains an array of integers <code>matrix</code> separated by space</li>",
    "outputFormat": "<li>Print the transposed matrix</li>",
    "sampleOutput": "1 4 7<br/>2 5 8<br/>3 6 9",
    "sampleInput": "1<br/>1 2 3<br/>4 5 6<br/>7 8 9",
    "constraints": "<li class='mt-2'><code>1 <= m, n <= 20</code></li><li class='mt-2'><code>-1000 <= matrix[i][j] <= 1000</code></li>",
    "difficulty": "Easy",
    "category": "Array",
    "order": 12,
    "videoId": "",
